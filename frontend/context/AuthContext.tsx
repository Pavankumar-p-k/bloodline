...
type User = { id: string; email: string; role?: 'donor' | 'hospital' | 'admin' }
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signup = async (email: string, password: string, role: User['role'] = 'donor') => {
    ...
    // backend should not auto-login to avoid mismatch; redirect to login
  ...
  return (
    <AuthContext.Provider value={{ user, token, loading, login, signup, signout, refreshUser }}>
      {children}
